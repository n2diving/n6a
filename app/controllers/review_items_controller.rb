class ReviewItemsController < ApplicationController
  ...
  private
    ...
    def review_item_params
      params.require(:review_item).permit(:name, :display_name, :evaluation_criteria, :scale_min, :scale_max, :start_date,:end_date, :response_allowed, :is_team, :is_weekly, :is_monthly_bonus )
    end
end
